      ...
      inputs.wrapper-modules.wrappers.niri.wrap {
        ...
        settings = {
          ...
          binds = {
            ...
            # Control Center
            "Mod+S".spawn-sh =
              "${noctalia} ipc call controlCenter toggle";

            # Settings
            "Mod+Comma".spawn-sh =
              "${noctalia} ipc call settings toggle";

            # Session Menu
            "Alt+F4".spawn-sh =
              "${noctalia} ipc call sessionMenu toggle";

            # Volume
            "XF86AudioRaiseVolume".spawn-sh =
              "${noctalia} ipc call volume increase";

            "XF86AudioLowerVolume".spawn-sh =
              "${noctalia} ipc call volume decrease";

            "XF86AudioMute".spawn-sh =
              "${noctalia} ipc call volume muteOutput";

            # Brightness
            "XF86MonBrightnessUp".spawn-sh =
              "${noctalia} ipc call brightness increase";

            "XF86MonBrightnessDown".spawn-sh =
              "${noctalia} ipc call brightness decrease";
